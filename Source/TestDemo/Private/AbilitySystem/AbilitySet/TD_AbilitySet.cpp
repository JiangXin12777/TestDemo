...
UTD_AbilitySet::UTD_AbilitySet(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UTD_AbilitySet::GiveToAbilitySystem(UTD_AbilitySystemComponent* InASC,
	FTD_AbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject) const
{
	check(InASC);
	...
	{
		const FTD_AbilitySet_GameplayAbility& AbilityToGrant = GrantedGameplayAbilities[AbilityIndex];
		...
		UTD_GameplayAbility* AbilityCDO = AbilityToGrant.Ability->GetDefaultObject<UTD_GameplayAbility>();
	...
	{
		const FTD_AbilitySet_GameplayEffect& EffectToGrant = GrantedGameplayEffects[EffectIndex];
	...
	{
		const FTD_AbilitySet_AttributeSet& SetToGrant = GrantedAttributes[SetIndex];
